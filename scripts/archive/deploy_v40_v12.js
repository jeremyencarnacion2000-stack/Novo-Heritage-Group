...
// V40.12: DEFINITIVE MODEL FIX + HARDCODED AUTH
const nodes = [
  {
    id: 'trigger',
...
function deploy() {
  const data = JSON.stringify({ name: 'PROD: Real Estate Pipeline (V40.12 Final Master)', nodes, connections, settings: { executionOrder: 'v1' } });
  const req = https.request({
    ...
    res.on('end', () => {
      console.log('=== V40.12 DEPLOYED (MASTER) ===');
