...
// V40.4: SQL SIMPLE + EXTRACCIÓN JS (ULTRA ESTABLE)
const nodes = [
  {
    id: 'trigger',
...
function deploy() {
  const data = JSON.stringify({ name: 'PROD: Real Estate Pipeline (V40.4 Master)', nodes, connections, settings: { executionOrder: 'v1' } });
  const req = https.request({
    ...
    res.on('end', () => {
      console.log('=== V40.4 DEPLOYED (MASTER STABILITY) ===');
