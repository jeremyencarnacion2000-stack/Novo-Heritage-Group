...
// V40.14: NATIVE FETCH (ZERO MODULES) + LLAMA 3.3
const nodes = [
  {
    id: 'trigger',
...
function deploy() {
  const data = JSON.stringify({ name: 'PROD: Real Estate Pipeline (V40.14 Final Native)', nodes, connections, settings: { executionOrder: 'v1' } });
  const req = https.request({
    ...
    res.on('end', () => {
      console.log('=== V40.14 DEPLOYED (NATIVE) ===');
