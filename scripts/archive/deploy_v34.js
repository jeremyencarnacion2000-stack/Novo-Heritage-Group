...
WHERE EXCLUDED.zona != 'N/A' 
  ...
  const db = new Client({ connectionString: 'postgresql://angel:NegdPai-zZFnyyNsT2jdmg@long-dwarf-15398.jxf.gcp-us-east1.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full' });
  await db.connect();
