    ...
    <div className="min-h-screen w-full flex items-center justify-center p-6 relative overflow-hidden bg-[#050505] selection:bg-primary/30">
      ...
      >
        <div className="text-center mb-12">
          <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary mb-6 block">Nueva Membresía</span>
          <h1 className="text-4xl md:text-5xl font-serif italic text-white tracking-tight mb-4">
            Comienza tu <span className="text-primary italic">legado</span>
          </h1>
          ...
          <CardContent className="p-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-[10px] uppercase tracking-[0.2em] text-primary font-black ml-1">
                    Identidad
                  </Label>
                  <div className="relative group">
                    <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-500 ${focusedInput === 'name' ? 'text-primary' : 'text-white/20'}`} />
                    <Input
                      id="name"
                      type="text"
                ...
                {/* Password */}
                <div className="space-y-2">
                  <Label htmlFor="password" className="text-[10px] uppercase tracking-[0.2em] text-primary font-black ml-1">
                    Código de Acceso
                  </Label>
                  <div className="relative group">
                ...
                {/* Confirm Password */}
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-[10px] uppercase tracking-[0.2em] text-primary font-black ml-1">
                    Confirmación
                  </Label>
                  <div className="relative group">
                    <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors duration-500 ${focusedInput === 'confirmPassword' ? 'text-primary' : 'text-white/20'}`} />
                    <Input
                      id="confirmPassword"
                      type={showPassword ? "text" : "password"}
                      placeholder="••••••••"
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-16 bg-primary text-black hover:bg-[#D4AF37] font-black text-[12px] uppercase tracking-[0.3em] rounded-none transition-all duration-500 shadow-[0_8px_30px_rgb(230,193,90,0.1)] mt-4"
              >
                {isLoading ? "Procesando..." : "Registrar Identidad"}
              </Button>
            </form>
            ...
            <div className="mt-10 space-y-6">
              <div className="relative">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-14 bg-white/[0.02] border-white/10 text-white hover:bg-white/[0.05] hover:border-primary/30 rounded-none transition-all duration-500 flex items-center justify-center gap-4 group"
                >
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.2em]">Registrarse con Google</span>
                </Button>
            </div>
            ...
            <div className="mt-10 text-center">
              <p className="text-white/30 text-[10px] uppercase tracking-widest font-medium">
                ¿Ya eres miembro?{" "}
                <Link href="/login" className="text-primary hover:text-white transition-colors border-b border-primary/20 hover:border-white ml-2 pb-0.5">
                  Acceso Privado
                </Link>
              </p>
            </div>
