...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { loginUser } = await import("@/lib/supabase/functions")
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                <Button
                  ...
                  variant="outline"
                  className="h-14 bg-white/[0.02] border-white/10 text-white hover:bg-white/[0.05] hover:border-primary/30 rounded-none transition-all duration-500 flex items-center justify-center gap-4 group"
                >
