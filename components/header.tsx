    ...
    >
      <div className="flex items-center gap-12">
        <Link href="/" className="transition-transform hover:scale-[1.05] flex-shrink-0">
          <Logo className="transition-all duration-500 brightness-0 invert h-20 md:h-24 w-auto min-w-[260px] md:min-w-[320px] drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]" />
        </Link>
