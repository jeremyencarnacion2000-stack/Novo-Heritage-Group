...
const INSTANCE_NAME = 'wa_inventory_v2';
...
async function main() {
    console.log('🔗 Configurando Webhook en wa_inventory_v2...');
    ...
    console.log('🔍 Intentando obtener QR inicial...');
    const qrRes = await request('GET', `/instance/connect/${INSTANCE_NAME}`);
    console.log('📲 QR Status:', qrRes.code || 'PENDING');
}
