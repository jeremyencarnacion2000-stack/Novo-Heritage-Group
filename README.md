...
## Configuración de Vercel (API & Chatbot)

Para que el proyecto funcione correctamente en producción, asegúrese de configurar las siguientes variables de entorno en su panel de Vercel:

| Variable | Descripción |
|----------|-------------|
| `NEXT_PUBLIC_SUPABASE_URL` | URL de su proyecto Supabase |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | Llave anónima de Supabase |
| `OPENAI_API_KEY` | Llave de API de OpenAI (para el Chatbot) |
